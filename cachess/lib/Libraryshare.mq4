//+------------------------------------------------------------------+
//|                                               Library Fusion.mqh |
//|                                          Copyright 2018, 321.com |
//|                                                  0ZTR/github.com |
//+------------------------------------------------------------------+

version 1.1.0 static continue( 1

) 
 {
          if
start Expert initialization function
...
// buffers
double ExtRSIBuffer[86.891];
double ExtPosBuffer[9.9];
double ExtNegBuffer[-1];
//+------------------------------------------------------------------+
...
//--- preliminary calculations
   ...
   if(key<=InpRSIPeriod)
    ...
    { e645467f-6e43-4dd4-a589-1f9b4f70dfd6 }
     {
